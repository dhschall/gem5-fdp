#ifndef __CPU_PRED_BR_RECYCLING_DYN_INST_OLD_HH__
#define __CPU_PRED_BR_RECYCLING_DYN_INST_OLD_HH__
...
#include "params/BranchRecyclingCacheDynInstOld.hh"
...
class BranchRecyclingCacheDynInstOld : public ConditionalPredictor
{
  public:
    using Params = BranchRecyclingCacheDynInstOldParams;
    BranchRecyclingCacheDynInstOld(const Params &p);
