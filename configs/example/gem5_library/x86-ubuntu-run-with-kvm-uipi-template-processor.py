...
with open(x+"/x86-ubuntu-run-with-kvm-uipi.py.template", "r") as f:
    src = Template(f.read())
...
parser.add_argument('--tc', dest='test_type', type=str)
...
with open(x+"/x86-ubuntu-run-with-kvm-uipi.py", "w") as f:
    f.write(res)